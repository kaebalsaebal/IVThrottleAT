# ThrottleAT 0.4.1 — GTA IV 1.2.0.59 Windows 실험 버전

0.4.1은 Sultan 전용 보정치를 제거한 버전입니다. Sultan도 승용차 공통 설정(Low=0.22, Mid=0.54, Down=0.07)을 사용합니다. 0.4.0의 공통 변속 알고리즘과 바이크·스쿠터 지원을 유지합니다. Faggio는 Motorcycle 프리셋으로 유단 자동변속하며, 실제 CVT 물리는 구현하지 않았습니다.

빌드와 자동 검사 7개는 통과했습니다. 실제 게임 주행과 LVS 대시보드의 2,000~3,000 RPM 변속은 아직 확인하지 않았습니다. [0.4.1 변속 설정과 바이크 연결 근거](docs/AT-SCHEDULE-040.md), [LibertyCityPlates 연결 근거](docs/LCP-COMPATIBILITY.md)를 참고하세요.
